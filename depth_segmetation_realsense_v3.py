...
from detection_hands import MediaPipe_Hand_Detector
...
def main():
    ...
    while True: 
        ...
        cv2.imshow('Align Example', cv2.flip(images,1))
        
        frame_result = mp_hand_detector.analyze_frame( color_image )
        cv2.imshow("Hand Detection", frame_result)
