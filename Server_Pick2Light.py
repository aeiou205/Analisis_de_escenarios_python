...
def visual_status_locations( rack_locations, cart_locations ):
    ...
    for loc in rack_locations:
        rack_viewer = rack_viewer.replace(str(loc), "**" )
    ...
    print("Registered location in CART: ")
    print(cart_viewer)
...
async def start(websocket, location_key):
    ...
    visual_status_locations( list(REGISTERED_RACK_LOCATIONS.keys()), list( REGISTERED_CART_LOCATIONS.keys)  )
